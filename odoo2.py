...
try:
	select = Select(driver.find_element_by_xpath("html/body/div[2]/table/tbody/tr/td[2]/div/div/div/div/div/div[3]/div/div[4]/div/div/table[5]/tbody/tr[1]/td[2]/table/tbody/tr/td[2]/span/select"))
...
try:
	driver.find_element_by_css_selector('.oe_button.oe_form_button_save.oe_highlight').click()
	print 'ok'
except:
	print 'no'
	driver.quit()
...
try:
	driver.find_element_by_xpath("html/body/div[2]/table/tbody/tr/td[2]/div/div/div/div/div/div[3]/div/div[4]/div/div/header/ul/li[4]/span[1]").click()							
	print 'ok'
except:
	print 'no'
	driver.quit()
